...
export default function DetailPage2() {
  const { id } = useParams();
  const item = productApi2.find((p) => p.id === Number(id));
      ...
      <div className="grid md:grid-cols-2 w-[90%] m-auto items-center shadow-2xl">
        ...
        <div className="mx-auto p-7">
          ...
          <div className="xl:flex m-4">
            ...
            <div className="my-4 ">
              <button className="text-md text-white font-semibold rounded shadow-2xl bg-[#1a9353] hover:bg-green-600 px-4 py-3">
                Add to Cart
